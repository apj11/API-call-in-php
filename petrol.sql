...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2019 at 10:31 AM
...
--
-- Table structure for table `petrol_report`
--

CREATE TABLE `petrol_report` (
  `year` int(255) NOT NULL,
  `petroleum_product` varchar(255) NOT NULL,
  `sale` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `petrol_report`
--

INSERT INTO `petrol_report` (`year`, `petroleum_product`, `sale`) VALUES
(2014, 'Petrol', 283567),
(2014, 'Diesel', 901393),
(2014, 'Kerosene', 18628),
